...
import com.oop.laba2.lab1.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var isFABSelected=false

        fab.setOnClickListener{
            if(isFABSelected) {
                textView.text = "хватит тыкать -_ -"

            }
            else {
                textView.text = "Лев Таня <:"
                isFABSelected=!isFABSelected
